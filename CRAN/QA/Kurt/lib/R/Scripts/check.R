...
GCC_14_compilers_KH <- "GCC 14.2.0 (Debian 14-2.0-8)"
...
check_flavors_db <- local({
    fields <-
        list(c("r-devel-linux-x86_64-debian-clang",
               ...
               "clang/flang-new version 19.1.3",
               "C.UTF-8",
               NA_character_
               ),
    ...
    fields <-
        list(c("ATLAS",
             ...
             c("valgrind",
               ...
               "https://www.stats.ox.ac.uk/pub/bdr/memtests/README.txt"),
             c("0len",
               "Tests for zero-length access segfaults",
               "https://www.stats.ox.ac.uk/pub/bdr/0len/README.txt"),
             ## TK
             c("rchk",
