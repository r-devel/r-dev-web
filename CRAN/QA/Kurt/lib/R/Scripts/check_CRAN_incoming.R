...
check_env_common <-
    c(paste0("LANG=", Sys.getenv("_R_CHECK_LANG_", "C.UTF-8")),
      ...
      ## dependencies.
      paste0("_R_INSTALL_PACKAGES_ELAPSED_TIMEOUT_=",
             Sys.getenv("_R_INSTALL_PACKAGES_ELAPSED_TIMEOUT_", "180m")),
      ## </FIXME>
      paste0("_R_CHECK_ELAPSED_TIMEOUT_=",
             Sys.getenv("_R_CHECK_ELAPSED_TIMEOUT_", "180m")),
      paste0("_R_CHECK_INSTALL_ELAPSED_TIMEOUT_=",
             Sys.getenv("_R_CHECK_INSTALL_ELAPSED_TIMEOUT_", "180m")),
      character()
      )
check_env <-
