...
gcc <- c("ChemmineR", "DESeq2", "GOSemSim", "RBGL", "Rdisop", "Rgraphviz", "Rsamtools", "affxparser", "edgeR", "flowCore", "flowWorkspace", "fmcsR", "ncdfFlow", "mzR", "pcaMethods", "qpgraph", "rtracklayer", "survcomp")
