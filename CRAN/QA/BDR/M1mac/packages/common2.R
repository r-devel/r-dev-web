...
opts <-
    list(ROracle = "--fake",
         ...
         gdalcubes = "--configure-args='--with-data-copy --with-proj-data=/opt/R/arm64/share/proj'",
         gdalraster = "--configure-args='--with-data-copy --with-proj-data=/opt/R/arm64/share/proj'",
         vol2birdR = "--configure-args='--with-data-copy --with-proj-data=/opt/R/arm64/share/proj'"
         )
