         ...
         details = character(), final = FALSE)
{
    ...
    fmt <- c("Dear maintainer,",
             ...
             "",
	     "The M1mac additional issues are from macOS 13.3 and version 14.3 of the CLT toolchain.",
	     "So it is unlikely that they can be reproduced on earlier",
	     "versions such as the mac-builder service.",
	     "",
	     "Hopefully the check results show enough for you",
