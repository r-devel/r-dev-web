         ...
         details = character(), final = FALSE)
{
    ...
    fmt <- c("Dear maintainer,",
             "",
             "Please see the problems shown in",
	     "https://www.stats.ox.ac.uk/pub/bdr/0len/",
	     "with reproduction details in the README.txt file",
             "",
	     "THe segfaults can be hard to reproduces, but likely",
	     "fixing the issues shown in the Alternative sub-directory",
	     "would suffice.",
	     "",
