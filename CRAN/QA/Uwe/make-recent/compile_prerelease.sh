...
wget https://cran.r-project.org/src/base-$state/R-latest.tar.gz
...
export fullname=R-$version$substate
mv $name R-$state
...
cp rtest.html NEWS.$fullname.html md5sum.$fullname.txt README.$fullname rw-FAQ.$fullname.html SVN-REVISION.$fullname $fullname-win.exe //store/ligges/public_html/CRAN/bin/windows/base
