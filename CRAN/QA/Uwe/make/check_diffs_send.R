...
try(check_results_diffs("3.4", flavor = "oldrel")) 
try(check_results_diffs("3.5", flavor = "release")) 
try(check_results_diffs("3.6", flavor = "devel", 
...
send_checks("3.6", Sys.Date(), Sys.Date()-1, send_external = Sys.getenv("Kurt") == "Kurt")
