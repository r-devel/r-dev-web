...
There are also three special classes of macros.  The \verb!\link{}!,
\verb!\linkS4class{}!, \verb!\linkS4methods{}!, and \verb!\Sexpr! macros
\label{sec:options}
...
\verb!\linkS4methods! & option plus 1 &   no     & no    & Latex-like \\
...
<<>>=
library(tools)
infile <- file.path(tools:::.R_top_srcdir(),
