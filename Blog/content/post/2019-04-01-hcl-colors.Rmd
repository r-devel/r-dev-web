...
hcl.swatch <- function(palette = hcl.pals(), n = 5, nrow = 16,
...
```{r swatch-plot, echo=FALSE, fig.height=8, fig.width=9.8, out.width="100%", dev="svg"}
hcl.swatch()
```
...
```{r image-heat, fig.show="hold", fig.height=5, fig.width=6, out.width="49%"}
...
```{r image-contour, fig.show="hold", fig.height=5, fig.width=6, out.width="49%"}
image(volcano)
