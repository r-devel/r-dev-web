...
palette_plot <- function(pal) {
  ...
  pal <- palette()
  n <- length(pal)
  grid::grid.text(pal, x = 1:n/(n + 1), y = 2/3, gp = grid::gpar(fontfamily = "mono"))
