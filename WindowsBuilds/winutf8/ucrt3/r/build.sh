...
export PATH=$THOME/x86_64-w64-mingw32.static.posix/bin:$THOME/x86_64-w64-mingw32.static.posix/libexec/gcc/x86_64-w64-mingw32.static.posix/10.2.0:$THOME/trunk/Tcl/bin:"/c/Program Files/MiKTeX/miktex/bin/x64":$PATH
