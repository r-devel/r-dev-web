[Setup]
AppName=Rtools
AppId=Rtools46TSUFFIX
AppVersion=4.6.VIVER3
VersionInfoVersion=4.6.VIVER3.VIVER4
...
DefaultDirName=C:\rtools46TSUFFIX
DefaultGroupName=Rtools 4.6
UninstallDisplayName=Rtools 4.6 (VIVER3-VIVER4TSUFFIX)
...
OutputBaseFilename=rtools46-RTARGET
...
Root: HKLM; Subkey: "SYSTEM\CurrentControlSet\Control\Session Manager\Environment"; ValueType: expandsz; Flags: uninsdeletevalue; ValueName: RTOOLS46_HOME_VARNAME; ValueData: "{app}"; Check: RIsAdmin
Root: HKCU; Subkey: "Environment"; ValueType: expandsz; Flags: uninsdeletevalue; ValueName: RTOOLS46_HOME_VARNAME; ValueData: "{app}"; Check: NonAdmin

[Files]
Source: "build\rtools46TSUFFIX\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs uninsremovereadonly
...
[Icons]
Name: "{group}\Rtools46TSUFFIX Bash"; Filename: "{app}\msys2.exe"; Tasks: createStartMenu; Flags: excludefromshowinnewinstall
