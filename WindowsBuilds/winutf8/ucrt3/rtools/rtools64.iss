[Setup]
AppName=Rtools
AppId=Rtools45TSUFFIX
AppVersion=4.5.VIVER3
VersionInfoVersion=4.5.VIVER3.VIVER4
...
DefaultDirName=C:\rtools45TSUFFIX
DefaultGroupName=Rtools 4.5
UninstallDisplayName=Rtools 4.5 (VIVER3-VIVER4TSUFFIX)
...
OutputBaseFilename=rtools45-RTARGET
...
Root: HKLM; Subkey: "SYSTEM\CurrentControlSet\Control\Session Manager\Environment"; ValueType: expandsz; Flags: uninsdeletevalue; ValueName: RTOOLS45_HOME_VARNAME; ValueData: "{app}"; Check: RIsAdmin
Root: HKCU; Subkey: "Environment"; ValueType: expandsz; Flags: uninsdeletevalue; ValueName: RTOOLS45_HOME_VARNAME; ValueData: "{app}"; Check: NonAdmin

[Files]
Source: "build\rtools45TSUFFIX\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs uninsremovereadonly
...
[Icons]
Name: "{group}\Rtools45TSUFFIX Bash"; Filename: "{app}\msys2.exe"; Tasks: createStartMenu; Flags: excludefromshowinnewinstall
