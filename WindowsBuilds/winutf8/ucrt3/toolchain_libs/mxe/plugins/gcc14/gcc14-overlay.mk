...
$(PKG)_URL_2      := https://ftp.gnu.org.uk/gnu/gcc/gcc-$($(PKG)_VERSION)/$($(PKG)_FILE)
#$(PKG)_URL_2    := https://www.mirrorservice.org/sites/sourceware.org/pub/gcc/snapshots/gcc-$($(PKG)_VERSION)/$($(PKG)_FILE)
$(PKG)_PATCHES  := $(dir $(lastword $(MAKEFILE_LIST)))/gcc14.patch \
                   $(dir $(lastword $(MAKEFILE_LIST)))/gcc14-1-libgomp-gfortran.patch
