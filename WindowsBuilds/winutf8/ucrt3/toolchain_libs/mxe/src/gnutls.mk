...
$(PKG)_DESCR    := GnuTLS
$(PKG)_VERSION  := 3.8.8
$(PKG)_CHECKSUM := ac4f020e583880b51380ed226e59033244bc536cad2623f2e26f5afa2939d8fb
...
$(PKG)_DEPS     := cc gettext gmp libidn2 libtasn1 libunistring nettle zlib brotli
