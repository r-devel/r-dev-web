...
# builds a gcc15 toolchain and the installation location is
...
#
# gcc15_ucrt3_full.tar.zst         native compilers and full set of Rtools libraries
# (llvm19_ucrt3_full_aarch64.tar.zst)
#
# gcc15_ucrt3_full_cross.tar.zst   cross compiler and cross-tools from a full build
# (llvm19_ucrt3_full_cross_aarch64.tar.zst)
#
# gcc15_ucrt3_base.tar.zst         native compilers and a subset of Rtools libraries
# (llvm19_ucrt3_base_aarch64.tar.zst)
#
# gcc15_ucrt3_base_cross.tar.zst   cross compiler and cross-tools from a base build
...
# as 
#
# gcc15_ucrt3_base_REV.tar.zst     copy of gcc15_ucrt3_base.tar.zst
# gcc15_ucrt3_cross_REV.tar.zst    copy of gcc15_ucrt3_full_cross.tar.zst
# gcc15_ucrt3_full_REV.tar.zst     copy of gcc15_ucrt3_full.tar.zst
#
