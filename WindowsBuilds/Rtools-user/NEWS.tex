...
starting from Suharto Anggono's suggestion in \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17555}{PR\#17555}.
...
\code{traceback()}.  This fulfils the wish of \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17580}{PR\#17580}, reported
...
Michael Chirico in \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17648}{PR\#17648}.
...
\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17652}{PR\#17652}.  Consequently, optional argument \code{addrownums} is
...
\code{deparse1(substitute(*))}, e.g., to fix \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17671}{PR\#17671}.
...
argument names, thanks to a patch proposal by Neal Fultz in \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17688}{PR\#17688}.
...
\code{r1}, fixing \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17719}{PR\#17719} reported by Serguei Sokol.
...
\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17598}{PR\#17598}.
...
data.  Contributed by Lionel Henry in \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17595}{PR\#17595}.
...
Based on patch from Lionel Henry submitted with \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17619}{PR\#17619}.
...
folders (\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17165}{PR\#17165}).

\item{} \code{md5sum()} supports UTF-8 file names with characters
that cannot be translated to the native encoding (\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17633}{PR\#17633}).
...
(\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17679}{PR\#17679}).
...
shortly after startup has been addressed (\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=16702}{PR\#16702}).

\item{} The \code{data.frame} method for \code{rbind()} no longer
drops \code{<NA>} levels from factor columns by default
(\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17562}{PR\#17562}).

\item{} \code{available.packages()} and hence \code{install.packages()}
now pass their \code{...} argument to \code{download.file()},
fulfilling the wish of \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17532}{PR\#17532}; subsequently,
\code{available.packages()} gets new argument \code{quiet}, solving
\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17573}{PR\#17573}.
...
PostScript, thanks to \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17607}{PR\#17607} by Daisuko Ogawa.
...
\item{} \code{write.dcf()} no longer mangles field names (\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17589}{PR\#17589}).
...
(for now) been replaced with much faster \R{} code (\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17624}{PR\#17624}).
...
consistently and have the same non-explicit default (\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17659}{PR\#17659}).
...
version. (\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=16056}{PR\#16056})
...
Duncan Murdoch in \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17669}{PR\#17669}.
...
overriding \code{SIMPLIFY} to \code{FALSE}. (\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17653}{PR\#17653})

\item{} \code{as.difftime()} gets new optional \code{tz = "UTC"}
argument which should fix behaviour during
daylight-savings-changeover days, fixing \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=16764}{PR\#16764}, thanks to
...
\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17668}{PR\#17668}.  \\{} \code{round(x, dig)} for \emph{negative} digits
...
due to \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17596}{PR\#17596} and a report from Ezra Tucker).
...
expressions (\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=16710}{PR\#16710}).

\item{} \code{smoothEnds(x)} now returns \code{integer} type in
\emph{both} cases when \code{x} is \code{integer}, thanks to a
report and proposal by Bill Dunlap \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17693}{PR\#17693}.
...
by Bill Dunlap, \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17721}{PR\#17721}).
...
Gillibert, \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17734}{PR\#17734})
...
Tyner, in \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=15886}{PR\#15886}.
...
fixing \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17730}{PR\#17730}.

\item{} \code{x[[Inf]]} (returning \code{NULL}) no longer leads to
undefined behavior, thanks to a report by Kirill Müller in
\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17756}{PR\#17756}.  Further, \code{x[[-Inf]]} and \code{x[[-n]]} now give
more helpful error messages.

\item{} \code{Gamma()} family sometimes had trouble storing
link name \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=15891}{PR\#15891}
...
some (less commonly used) characters (\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17638}{PR\#17638}).
...
\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17632}{PR\#17632}).

\item{} \code{scan()} issues with UTF-8 data when running in a DBCS
locale have been resolved (\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=16520}{PR\#16520}, \Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=16584}{PR\#16584}).
...
\command{toupper()} (\Rhref{https://bugs.R-project.org/bugzilla3/show_bug.cgi?id=17645}{PR\#17645}).
